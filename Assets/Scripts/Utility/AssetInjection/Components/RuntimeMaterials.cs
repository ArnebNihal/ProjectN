    ...
    public sealed class RuntimeMaterials : MonoBehaviour
    {
        ...
        private void ApplyMaterials(bool force, int[] dungeonTextureTable = null)
        {
            ...
            try
            {
                ...
                ClimateSeason season = DaggerfallUnity.Instance.WorldTime.Now.GenericSeasonValue == DaggerfallDateTime.Seasons.Winter ? ClimateSeason.Winter : ClimateSeason.Summer;
