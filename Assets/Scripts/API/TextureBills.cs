...
namespace DaggerfallConnect.Arena2
{
    ...
    /// </summary>
    public class TextureBills : BaseImageFile
    {
        ...
        public TextureBills(string filePath, FileUsage usage, bool readOnly)
        {
        ...
        /// <param name="readOnly">File will be read-only if true, read-write if false.</param>
        public TextureBills(string filePath, FileUsage usage, DFPalette palette, bool readOnly)
        {
            myPalette = palette;
            Load(filePath, usage, readOnly);
        }
        ...
        /// <param name="readOnly">File will be read-only if true, read-write if false.</param>
        public TextureBills(string filePath, FileUsage usage, string paletteFilePath, bool readOnly)
        {
            Load(filePath, usage, readOnly);
