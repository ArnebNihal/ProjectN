    ...
    public class DarkBrotherhoodRR : DarkBrotherhood
    {
        ...
        public override TextFile.Token[] TokensExpulsion()
        {
            ...
            return new TextFile.Token[] {
                TextFile.CreateTextToken(TextManager.Instance.GetLocalizedText("DarkBrotherhoodExpulsion1")),
                TextFile.CreateFormatToken(TextFile.Formatting.JustifyCenter),

                TextFile.CreateTextToken(TextManager.Instance.GetLocalizedText("DarkBrotherhoodExpulsion2")),
                TextFile.CreateFormatToken(TextFile.Formatting.JustifyCenter),

                TextFile.NewLineToken,

                TextFile.CreateTextToken(TextManager.Instance.GetLocalizedText("DarkBrotherhoodExpulsion3")),
                TextFile.CreateFormatToken(TextFile.Formatting.JustifyCenter),

                TextFile.CreateTextToken(TextManager.Instance.GetLocalizedText("DarkBrotherhoodExpulsion4")),
                TextFile.CreateFormatToken(TextFile.Formatting.JustifyCenter),
            };
        }
