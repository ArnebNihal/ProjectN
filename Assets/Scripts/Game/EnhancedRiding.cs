...
namespace DaggerfallWorkshop.Game
{
    public class EnhancedRiding : MonoBehaviour
    {
        ...
        const int followTerrainSoftenFactor = 8;
        ...
        int sampleIdx = 0;
        int softenFollow = followTerrainSoftenFactor;
        ...
        public bool RealisticMovement = true;
        public bool TerrainFollowing = true;

        public bool GallopingInTowns = true;
        public bool TrampleCivilians = true;

        void Awake()
        {
            // GameObject playerAdvGO = GameObject.Find("PlayerAdvanced");
            // Debug.Log("enhancedRiding == null: ");
            // if (playerAdvGO)
            // {
            //     EnhancedRiding enhancedRiding = playerAdvGO.AddComponent<EnhancedRiding>();
            //     if (enhancedRiding != null)
            //     {
            //         enhancedRiding.RealisticMovement = true;
            //         enhancedRiding.TerrainFollowing = true;
            //         enhancedRiding.SetFollowTerrainSoftenFactor(followTerrainSoftenFactor);
            //         enhancedRiding.GallopingInTowns = true;
            //         enhancedRiding.TrampleCivilians = true;
            //     }
            // }
        }
